...
OBS: Podemos ter acesso a documentação de uma função em Python utilizando a propiedade especial __doc__
...
def exponencial(numero, potencia=2):
    ...
    :param potencia: Potencia que queremos gerar exponencial. Por padrão é 2.
